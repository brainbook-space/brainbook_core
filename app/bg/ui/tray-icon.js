...
export function setup () {
  ...
  tray.setToolTip('BrainBook Browser')
...
async function buildMenu () {
  ...
  const contextMenu = Menu.buildFromTemplate([
    ...
    {type: 'separator'},
    {type: 'checkbox', label: 'Let BrainBook run in the background', checked: runBackground, click: () => onTogglePersist(!runBackground)},
    {label: 'Quit BrainBook', click: () => app.quit()}
  ])
